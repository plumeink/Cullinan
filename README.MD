...
- **v0.7.0+ (Current)** - New architecture with enhanced features
- **[v0.6.x Documentation](docs/v0.6x/)** - Legacy version (deprecated)
...
│   ├── __init__.py
│   └── api.py
├── services/            # Services (NEW in v0.7.0)
│   ├── __init__.py
│   ├── user.py
│   └── email.py
└── models/              # Models
...
├── 07-registry-center.md        # Registry pattern guide (NEW)
├── 08-service-layer.md          # Service layer guide (NEW)
└── v0.6x/                       # v0.6.x documentation (legacy)
```
