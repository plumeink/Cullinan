# -*- coding: utf-8 -*-
"""Cullinan application lifecycle public entrypoint.

`cullinan.application.lifecycle` is the single application-level runtime facade for
startup and shutdown orchestration. It integrates ApplicationContext refresh,
service discovery verification, and graceful process shutdown.
"""
